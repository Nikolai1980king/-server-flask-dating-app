    ...
    return render_template_string('''
        ...
        <body>
            <div class="terms-container">
                ...
                <div class="section">
                    <h2>Судебная юрисдикция</h2>
                    <p>Любой спор по вопросу использования сервиса Сайта между Пользователем и Владельцем будет разбираться в городе регистрации Компании Владельца Сайта. Никакие другие суды не будут иметь полномочий заниматься этим спором.</p>
                </div>
