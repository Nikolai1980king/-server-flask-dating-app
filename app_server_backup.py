        ...
        <body>
            ...
            <div class="form-container">
                ...
                <div style="display: flex; gap: 10px; align-items: center;">
                    <input type="text" name="venue" id="venue-input" placeholder="Название заведения (кафе, ресторан и т.д.)" required style="flex: 1;" onchange="updateVenueCoordinates()">
                </div>
...
def like_profile(id):
    ...
    if Like.query.filter_by(user_id=user_id, liked_id=id).first():
        return "Вы уже лайкнули этого пользователя", 400
    ...
    return render_template_string('''
        ...
        <body>
            ...
            <form id="chat-form" autocomplete="off">
                <textarea id="message-input" name="message" placeholder="Ваше сообщение..." required></textarea>
            ...
            <script>
                ...
                document.getElementById('chat-form').onsubmit = function(e) {
                    ...
                    if (msg.trim()) {
                        // Отправляем только через Socket.IO
...
def handle_send_message(data):
    ...
    text = data['text']
    sender = data['sender']
    db.session.add(Message(chat_key=room, sender=sender, text=text))
    db.session.commit()
